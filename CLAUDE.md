...
**8. Keep chat code short.** Any code shown in the chat must be no more than twenty(20) lines at a time. This gives the user time to understand each step, learn the structure, and steer the implementation.
...
7. Share no more than twenty(20) lines of code in the chat, flagging any non-obvious language mechanics and simpler alternatives up front.
...
14. If document called Document-2 doesn't exist create one
15. Continously update the document in line with DocumentationTemplate.md but code that's on main branch
