...
**8. Keep chat code short.** Any code shown in the chat must be no more than ten lines at a time. This gives the user time to understand each step, learn the structure, and steer the implementation.
...
7. Share no more than ten lines of code in the chat, flagging any non-obvious language mechanics and simpler alternatives up front.
...
14. If document called Document-1 doesn't exist create one
